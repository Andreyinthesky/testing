...
namespace HomeExercises
{
	public class NumberValidatorTests
	{
        ...
        [TestCase(5, 3, false, "5.5.5", ExpectedResult = false, TestName = "when value have more then one decimal point")]
		[TestCase(3, 2, false, "+1.23", ExpectedResult = false, TestName = "when length value with plus more than precision")]
		[TestCase(3, 2, false, "-0.00", ExpectedResult = false, TestName = "when length value with minus more than precision")]
		...
		[TestCase(3, 2, false, ".02", ExpectedResult = false, TestName = "when value have nothing before decimal point")]
        [TestCase(17, 2, true, "something", ExpectedResult = false, TestName = "when value have letters only")]
		[TestCase(3, 2, true, "a.02", ExpectedResult = false, TestName = "when value have letters before decimal point")]
		[TestCase(3, 2, true, "a.sd", ExpectedResult = false, TestName = "when value have letters before and after decimal point")]
        [TestCase(4, 2, false, "-a.02", ExpectedResult = false, TestName = "when value with minus and have letters after decimal point")]
		...
		[TestCase(3, 2, false, "-0,0", ExpectedResult = true, TestName = "when value have minus and separated by comma")]
